...
function tags_exclude(tags,btn){
  ...
  $.ajax({
    type:"POST",
    url: "/account/tags/relation/remove/" + post_id,
    data: {
      tags : tags
    },
    success : function(json){
...
function tags_include(tags,btn){
  ...
  $.ajax({
    type:"POST",
    url: "/account/tags/relation/add/" + post_id,
    data: {
      tags : tags
    },
    success : function(json){
