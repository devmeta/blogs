                    ...
                    <ul class="nav navbar-nav navbar-right navbar-uppercase">
                        <li class="social-links">
                            ...
                            <?php if(session('user_id')):?>
                                <a href="/logout" title="<?php print locale('logout');?>" data-placement="right"><span class="typcn typcn-key"></span></a>
                            <?php else:?>
                                <a href="/login" title="<?php print locale('login');?>" data-placement="right"><span class="typcn typcn-key"></span></a>
                            <?php endif;?>
                        </li>
                        <li>
                            <a class="<?php echo (segments(2) == 'posts' ? ' active' : '');?>" href="/account/posts"><?php print locale('posts');?></a>
                        </li>
                        <li>
                            <a class="<?php echo (segments(2) == 'words' ? ' active' : '');?>" href="/account/words"><?php print locale('words');?></a>
                        </li>
                        <li>
                            <div class="dropdown">
